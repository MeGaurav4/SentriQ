# Drift Guard — Configuration Drift Detection

Drift Guard is a web-based configuration drift detection tool for server fleets. Import parameters and baselines via Excel, run curated drift detection against defined rules, and export findings. No collectors, no agents — purely Excel-driven.
